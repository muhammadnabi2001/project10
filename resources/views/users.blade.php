                                ...
                                <div class="modal-body">
                                    <form action="/createuser" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="input user role"
                                                name="role">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">User password</label>
                                            <input type="password" class="form-control" placeholder="input user password"
                                                name="password">
                                        </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel{{ $user->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel{{ $user->id }}">Edit Post</h1>
